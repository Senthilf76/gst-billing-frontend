...
export default function Bill() {
  ...
  <td><input className="table-input" value="0" readOnly/></td>
  ...
  <td>
  <table className="rightGrid">
  <tbody>
  <tr>
  <td>Invoice No.<br/><b>{invoiceNo}</b></td>
  <td>Dated<br/><b>{date}</b></td>
  </tr>
